  ...
  try {
    ...
    const backupData = {
      ...
      statistics: {
        ...
        totalFlights: databaseData.flights.length,
        totalAirlines: databaseData.airlines.length,
        totalAirports: databaseData.airports.length,
        ...
        totalAdminUsers: databaseData.adminUsers.length,
      }
    }
